...
using ProdavnicaAspDarko.Implementation.Email;
using ProdavnicaAspDarko.Implementation.Logging;
...
namespace ProdavnicaAspDarko.Api
{
    public class Startup
    {
        ...
        {
            services.AddTransient<ProdavnicaAspDarkoContext>();
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "ProdavnicaAspDarko", Version = "v1" });
